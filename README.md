...
![게시글 상세 화면](images/image-4.png)

- 회원 인증 기반 게시글·댓글·대댓글 CRUD 기능 구현
- 작성자 검증을 통해 수정/삭제 권한 제어
- 게시글 추천/추천 취소 기능으로 사용자 상호작용 구현
- 로그인 사용자만 기능 이용 가능하도록 접근 제어 적용
